...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        try {
            ...
            classifierListener?.onError(context.getString(R.string.image_classifier_failed_to_initialize))
        }
    }
    ...
    private fun toBitmap(imageUri: Uri): Bitmap {
        return BitmapFactory.decodeFile(uriToFile(imageUri, context).path)
    }
